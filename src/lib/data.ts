...
export const clientesData: Cliente[] = [
  ...
  {
    id: 7,
    clienteId: "8899001122",
    origen: "Referido",
    usuario: UsersData[12],
    cuenta: "Finance",
    asignadas: 28,
    perdidas: 4,
    canceladas: 8,
    ...
    contactos: [
      {
        ...
        correo: "maria.garcia@finance.com",
        nombre: "María",
        puesto: "Directora Financiera",
      },
      {
        celular: "55 9999 0000",
        correo: "carlos.lopez@finance.com",
        nombre: "Carlos",
    ...
    dias_credito: 30,
    tipo_factura: "PUE",
    razon_social: "Finance Solutions",
    regimen: "S.A. DE C.V.",
    tipo: "Moral",
    rfc: "FIN123456789",
    cp: "06500",
    como_factura: "Portal web",
    comentarios: [
      {
        id: 1,
        texto: "Cliente muy profesional y puntual en los pagos",
        fecha: "12/20/25",
        hora: "10:30am",
        autor: UsersData[3],
        tipo: "Comentario",
      ...
      {
        id: 2,
        texto: "Seguimiento semanal de vacantes activas",
        fecha: "12/19/25",
        hora: "3:45pm",
        autor: UsersData[3],
        tipo: "Tarea",
        fechaEntrega: "Vie 23/12/25",
      },
    ],
  },
];
...
export const vacantes: Vacante[] = [
  ...
  },
  {
    ...
    fee: 15,
    cliente: clientesData[0],
    checklist: "checklist_19.pdf",
    muestraPerfil: "perfil_19.pdf",
    ternaFinal: [],
  },
  {
    id: 20,
    ...
    valorFactura: 12000,
    fee: 20,
    checklist: "checklist_20.pdf",
    muestraPerfil: "perfil_20.pdf",
    ternaFinal: [
      {
        nombre: "Ana López",
        telefono: "555-1234",
  ...
  },
  {
    ...
    valorFactura: 14400,
    fee: 20,
    checklist: "checklist_21.pdf",
    muestraPerfil: "perfil_21.pdf",
    ternaFinal: [
      {
        nombre: "Pedro Sánchez",
        telefono: "555-4321",
